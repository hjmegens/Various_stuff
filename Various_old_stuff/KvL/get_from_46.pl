...
use lib "/usr/local/lib/kvl_lib/EnsEMBL46/ensembl/modules/";
use lib "/usr/local/lib/kvl_lib/EnsEMBL46/ensembl-variation/modules/";
use lib "/usr/local/lib/kvl_lib/EnsEMBL46/ensembl-compara/modules/";
use lib "/usr/local/lib/kvl_lib/EnsEMBL46/bioperl-live/";

print STDERR '@INC: '.join("\n",@INC)."\n";
use Bio::EnsEMBL::Registry;
use Bio::EnsEMBL::DBSQL::DBAdaptor;
my $reg_conf46 = "/usr/local/lib/kvl_lib/ensembl_init_46";
